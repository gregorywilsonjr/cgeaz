...
| Someone changed Azure, and I heard about it | The change alert had fired four times by 2026-09-22, the last of them for the state-account change, and section 7 of [EVIDENCE.md](docs/EVIDENCE.md) lists every fire next to the alert's own settings |
